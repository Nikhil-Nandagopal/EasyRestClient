...
import com.easydroid.domains.FormRequest;
import com.easydroid.utils.EasyCommonUtils;
import com.easydroid.utils.RequestMethod;

public class EasyFormServiceRequest extends EasyServiceRequest {

    private FormRequest request;

    public EasyFormServiceRequest(FormRequest request, RequestMethod requestMethod, Context context) {
        super(requestMethod);
